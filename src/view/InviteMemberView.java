...
public class InviteMemberView extends Application {
	    ...
	    public void start(Stage primaryStage) {
	        try {
	            ...
	            FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/InviteMember.fxml"));
	            ...
	            scene.getStylesheets().add(getClass().getResource("InviteMember.css").toExternalForm());
